...
export function Professionals({ professionals }: ProfessionalsProps) {
  return (
    <section id="clinicas" className="bg-gray-300 py-16">
              ...
              <CardContent className="p-0">
                ...
                <div className="p-4 space-y-4 min-h-[160px] flex flex-col justify-between">
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="w-full bg-cyan-600 hover:bg-cyan-500 text-white flex items-center justify-center py-2 rounded-md text-sm font-medium"
                  >
                    Agendar horário
